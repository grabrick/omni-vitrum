...
const minProducts = [
  {
    ...
    image: "https://bentglass.ru/public/products/Images/bent-glass/bent-glass3.png",
    linkRouter: "/products/bent-glass",
    revers: false,
  ...
  },
  {
    ...
    image: "https://bentglass.ru/public/products/Images/bent-triplex/bent-triplex2.png",
    linkRouter: "/products/bent-triplex",
    revers: true,
  ...
  },
  {
    ...
    image: "https://bentglass.ru/public/products/Images/spherical-glass/spherical1.png",
    linkRouter: "/products/spherical-glass",
    revers: false,
    text: "Есть различные модели представленных конструкций. Они отличаются размерами, оттенком основания, видом и дизайном. Ассортимент представляет низкие и высокие, широкие и узкие варианты для современных и классических интерьеров.",
  },
];
